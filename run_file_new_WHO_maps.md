...
#ID for 1000 sets on laptop: "20260301-165151-b4e953ab"

# Calculate outbreak risk from second case data set
orderly_run("get_outbreak_risk_R0_case_seeding",list(calc_id="20260301-165151-b4e953ab"))
#ID for 1000 sets on desktop: "20260218-153524-311053c1"
#ID for 1000 sets on laptop: "20260301-171942-3390d143"

# Calculate outbreak risk based on seeding weighted by Raptor data
orderly_run("outbreak_risk_seeded_weighted_by_raptor_data",
  list(calc_id="20260218-150627-14bbbc27",
  raptor_results_filename="all_DS_results_neighbours 1.rds"))
...
orderly_run("R0_violin_plot_WHO")

# Create plot of adm1 level starting locations?
#TODO?
# Need to check how starting location frequency from old map (Fig7 in Medrxiv preprint) determined