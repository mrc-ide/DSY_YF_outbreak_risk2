...
orderly2::orderly_artefact("All data", "case_data_seeded_R0_selected_datasets.Rds")
...
saveRDS(case_data_multi$case_data,file="case_data_seeded_R0_selected_datasets.Rds")