...
orderly2::orderly_artefact(description="Risk map", files=c("outbreak risk map (FOI+R0).png"))
orderly2::orderly_artefact(description="Risk data frame", files=c("outbreak_risk (FOI+R0).csv"))
