...
for(data_select in c(1,2,3,4,5)){
  ...
  map_FOI=create_map(shape_data=shape_data,param_values=FOI_values2,text_size=8,
  ...
  map_R0=create_map(shape_data=shape_data,param_values=R0_values2,text_size=8,
                    display_axes=FALSE,border_colour_regions = "grey",
